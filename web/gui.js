...
export class ContextMenu extends VerticalLayoutManager {
    add_option(option, text, font_name = "Minecraft") {
...
export class GuiButton {
    constructor(callBack, text, width = 200, height = 50, fontSize = 12, pressedColor = GuiButton.default_pressedColor, unPressedColor = GuiButton.default_unPressedColor, fontName = "Minecraft", outline_color = GuiButton.default_outline_color, text_color = GuiButton.default_text_color) {
...
export class GuiTextBox {
    constructor(key_listener, width, submit = null, fontSize = 16, height = 2 * fontSize, flags = GuiTextBox.default, validationCallback = null, selectedColor = new RGB(80, 80, 220), unSelectedColor = new RGB(100, 100, 100), outline = true, fontName = "Minecraft", customFontFace = null) {
        this.keys_held = null;
